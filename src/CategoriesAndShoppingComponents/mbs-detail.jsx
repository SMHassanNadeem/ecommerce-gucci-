...
export default function MBSDetail() {
    ...
    return (
        <div className="w-full h-auto">
            ...
            {isLoading ? (
                ...
                <div onClick={() => { navigate(`/men-bags/${p.id}`) }} key={p.id} className="flex flex-col border w-full h-auto bg-[#e7e7e7]">
